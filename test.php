    ...
    ?>
      ...
      <body>
        <div class="containter-fluid">
          <div class="row mt-4 mb-4">
            <div class="col-12 ml-2">
                  <center>
                    <a href="test.php?cinsiyet=erkek"><i class="fas fa-venus icon-3x" style="color:#00F;"></i></a>
                    <a href="test.php?cinsiyet=kadin"><i class="fas fa-mars icon-3x" style="color:#F00; margin-left:10px"></i></a>
                    <a href="test.php?cinsiyet=unisex"><i class="fas fa-venus-mars icon-3x" style="color:#000; margin-left:10px"></i></a>
                  </center>
              <table class="table">
                <tbody>
                  <tr>
                    <td colspan=2><center><img src="<?=$data["fotograf"]?>" class="img-thumbnail rounded <?php if($cinsiyet == "erkek") echo"border-primary"; else if($cinsiyet == "kadin") echo"border-danger"; else echo "border-dark";?>" width="300px" height="300px"></img></center></td>
                  </tr>
                  <tr>
                    <td>Ad Soyad</td>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <p><a href="api_info.php">api için tıklayın</a></p></center>
        ...
        <?php include '../needed/include/footer.html'; ?>
          <?php include '../needed/include/js.html'; ?>
      </body>
</html>
